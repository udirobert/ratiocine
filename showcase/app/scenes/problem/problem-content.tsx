  ...
  <div className="relative flex h-svh w-full flex-col overflow-hidden bg-[#0a0f2e] text-white selection:bg-white/20">
    ...
    <div className="flex items-center justify-between px-8 pt-8 pb-4 border-b border-white/10">
      ...
      <div className="text-right">
        <p className="font-mono text-xs text-white/40">task_lang</p>
        <p className="font-mono text-sm text-white/80">apu (Apurinã)</p>
      </div>
    </div>
          ...
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="border-b border-white/10">
                <th className="text-left py-2 pr-6 font-mono text-white/40 font-normal text-xs">
                  #
                </th>
                <th className="text-left py-2 pr-10 font-semibold text-white/70">
                  Apurinã
                </th>
                <th className="text-left py-2 font-semibold text-white/70">
                  English
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-white/5">
              {[
                ...
                <tr key={n} className="group">
                  <td className="py-2 pr-6 font-mono text-xs text-white/30">
                    {n}
                  </td>
                  <td className="py-2 pr-10 font-mono text-[#7dd3fc]">{apu}</td>
                  <td className="py-2 text-white/80">{eng}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <ol className="space-y-3">
          {[
            ...
            <li key={i} className="flex items-start gap-3">
              <span className="font-mono text-xs text-white/30 mt-0.5 w-5 shrink-0">
                {i + 1}.
              </span>
